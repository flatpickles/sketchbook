// #include "../math/mod289.glsl" // (also included in permute.glsl)
...
float cnoise(in vec4 P){
    ...
    vec4 gx00=ixy00*(1./7.);
    vec4 gy00=floor(gx00)*(1./7.);
    vec4 gz00=floor(gy00)*(1./6.);
    gx00=fract(gx00)-.5;
    gy00=fract(gy00)-.5;
    gz00=fract(gz00)-.5;
    ...
    vec4 gx01=ixy01*(1./7.);
    vec4 gy01=floor(gx01)*(1./7.);
    vec4 gz01=floor(gy01)*(1./6.);
    gx01=fract(gx01)-.5;
    gy01=fract(gy01)-.5;
    gz01=fract(gz01)-.5;
    ...
    vec4 gx10=ixy10*(1./7.);
    vec4 gy10=floor(gx10)*(1./7.);
    vec4 gz10=floor(gy10)*(1./6.);
    gx10=fract(gx10)-.5;
    gy10=fract(gy10)-.5;
    gz10=fract(gz10)-.5;
    ...
    vec4 gx11=ixy11*(1./7.);
    vec4 gy11=floor(gx11)*(1./7.);
    vec4 gz11=floor(gy11)*(1./6.);
    gx11=fract(gx11)-.5;
    gy11=fract(gy11)-.5;
    gz11=fract(gz11)-.5;
